...
function MobileMap() {
  return (
    <>
      <div className="max-w-7xl p-10 mx-auto flex lg:justify-between justify-center m-20 max-lg:gap-11 flex-wrap">
        <div className="md:w-1/3">
          <div className="relative bg-[url('./assets/mobilePhoto.png')] h-[31rem] w-60 bg-cover ">
            <div className="h-[20rem] md:h-[25rem] w-[264px] md:w-[261px] top-10 absolute left-5">
